...
export default function Worker() {
	...
	const [action, setAction] = useState<LinkArchiveActionSchemaType | undefined>();
				...
				if (error) {
					...
					if (action === "allAndIgnore") {
						...
						if (data.count === 0) {
							...
							toast.success(t("successfully_represerved_links", { count: data.count }));
						}
					}
				}
			},
	...
	return (
		<SettingsLayout>
			...
			{showModal && action && (
				<ConfirmationModal title={action === "allAndIgnore" ? t("delete_all_preservations") : t("delete_all_preservations_and_regenerate")} onConfirmed={() => submit(action)} toggleModal={setShowModal}>
