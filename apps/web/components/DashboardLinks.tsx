...
export function Card({ link, editMode }: Props) {
  ...
  return (
    <div
      ref={ref}
      className={`${selectedStyle} w-52 border border-solid border-neutral-content bg-base-200 shadow-md hover:shadow-none duration-100 rounded-xl relative group`}
      onClick={() =>
        selectable
    ...
    >
      <div
        className="rounded-xl cursor-pointer h-full w-52 flex flex-col justify-between"
        onClick={() =>
