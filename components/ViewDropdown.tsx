...
export default function ViewDropdown({ viewMode, setViewMode }: Props) {
  let viewModes: Array<{ mode: ViewMode; name: string }> = [
    { mode: ViewMode.Default, name: "Default" },
    { mode: ViewMode.Compact, name: "Grid" },
    { mode: ViewMode.List, name: "List" },
  ];

  return (
    <div className="p-1 flex flex-row gap-0.5 border border-neutral-content rounded-md">
      <button
        onClick={(e) => setViewMode(ViewMode.Default)}
      ...
      <button
        onClick={(e) => setViewMode(ViewMode.Compact)}
        className={`p-2 rounded-md ${
      ...
      <button
        onClick={(e) => setViewMode(ViewMode.List)}
        className={`p-2 rounded-md ${
