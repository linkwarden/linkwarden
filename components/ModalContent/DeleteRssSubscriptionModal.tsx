...
export default function DeleteRssSubscriptionModal({ onClose, rssSubscription }: Props) {
	const { t } = useTranslation();
	const [subscription, setSubscription] = useState<RssSubscription>(rssSubscription);
